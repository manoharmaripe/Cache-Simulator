...
int main()
{
    ...
    while (fgets(line, sizeof(line), file) != NULL)
    {
        ...
        if (strcmp(address[0], "R") == 0 || (strcmp(address[0], "W") == 0 && strcmp(wpolicy, "WB") == 0))
        {
            int x = 0;
            int found = 0;
            int indextonew = associativity;
            ...
            if (found == 0)
            {
                ...
                else if (indextonew == associativity)
                {
                    if (strcmp(policy, "LRU") == 0)
                    {
                    ...
                    else if (strcmp(policy, "RANDOM") == 0)
                    {
                        ...
                        int replaceindex = rand();
                        replaceindex = (replaceindex % range) + 0;
                        printf("MISS, ");
                        numofmisses++;
                        cache[setindex][replaceindex].tag = tag;
                        cache[setindex][replaceindex].replacepolicy = replacementcheck;
        ...
        else if (strcmp(address[0], "W") == 0 && strcmp(wpolicy, "WT") == 0)
        {
            int x = 0;
            int found = 0;
            int indextonew = associativity;
